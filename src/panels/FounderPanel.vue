...
<template>
  <div class="panel">
    <div class="big title">We build beautiful, functional websites that help local businesses succeed.</div>
    <div class="tag"> MEET OUR COMPANY </div>
...
.aboutImg{
  grid-column: span 2;
  background-image: url("/agency/agency9.jpg");
